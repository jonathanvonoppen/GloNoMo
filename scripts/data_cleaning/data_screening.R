...
# n unique regions
miren_roads %>% pull(Region) %>% unique() %>% length()  #> 26

# n unique roads
miren_roads %>% pull(Road) %>% unique() %>% length()  #> 75
...
# n unique regions
miren_trails %>% pull(Region) %>% unique() %>% length()  #> 10

# n unique roads
miren_trails %>% pull(Trail) %>% unique() %>% length()  #> 53
